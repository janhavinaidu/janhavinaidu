...
I'm **Janhavi Naidu**, a **3rd-year Computer Science (AIML) student at RCOEM** with a **CGPA of 9.23**, passionate about building **AI-automated solutions** and **end-to-end production-ready applications**.
...
|--------|-------------|------|
| **SaaS Management Platform** | Centralized SaaS license & employee access manager for enterprise tools | TypeScript, React, Node.js |
| **Med-Analyzer** | Medical document analyzer for structured extraction & reporting | TypeScript, NLP, OCR |
| **Facial Emotion Recognition** | Detects human emotions using CNN & OpenCV | Python, TensorFlow, CV |
